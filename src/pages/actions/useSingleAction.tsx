...
import { Card, CardBody, CardHeader, Divider, Image, Modal, ModalBody, ModalContent, ModalHeader, useDisclosure } from "@nextui-org/react"
			...
			<Modal isOpen={ isOpen } onOpenChange={ onOpenChange } size="lg" placement="center">
				<ModalContent>
					...
					<ModalBody className="grid grid-cols-3 gap-2 px-10 py-5">
						<span/>
						<Card className="hover:scale-[1.05] mx-auto bg-default-100" isPressable onPress={ () => confirm(target.id) } isDisabled={ actions.condition && !actions.condition(target) }>
